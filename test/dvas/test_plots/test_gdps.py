...
Module contents: Testing classes and function for dvas.plots.gdps module.
...
def gdp_2_prfs(db_init):
    ...
    oids = [item['oid'] for item in db_init.data[:-1]]
...
def test_gdp_vs_cws(gdp_2_prfs, gdp_1_prf, do_latex, show_plots):
    """ Test the multiprf plotting routine.

    do_latex is a fixture that is True if pytest is being run with the argument "--latex".
